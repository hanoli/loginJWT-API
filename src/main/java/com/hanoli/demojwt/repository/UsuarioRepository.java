...
public interface UsuarioRepository extends CrudRepository<Usuario, Long>{
	...
	@Query("update Usuario u set u.nombre=:nombre, u.apellidoPat=:apellidoPat, u.apellidoMat=:apellidoMat,u.direccion=:direccion, u.telefono=:telefono, u.username=:username,u.password=:password where u.id = :id")
